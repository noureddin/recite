...
<<!!bash -c 'for id in {sura,aaya}_{bgn,end} qaris player title txt txt_txt quizmode feedbackrate endmsg ok new repeat selectors header end_of_header zzback zzignore mvbtns_disablehack mvbtns {next,prev}{word,jmla,aaya}; do echo "const el_$id = Qid(\"$id\")"; done'>>
